...
var fullName = 'francisco-vaz'; 
var up = fullName.charAt(0).toUpperCase();
var semInicio = fullName.substring(1);
var resultadoFinal = up + semInicio.replace('-' , '/');
...
*/
console.log( '\nMeus amigos:' );
var names = ['francisco' , 'jose' , 'tomas' , 'vaz' , 'maria'];
var nameString = names.reduce(function (acumulado , atual , index) {
...
*/
console.log( '\nParte de uma string:' );
console.log('Francisco'.substring( 9, 4 ));
